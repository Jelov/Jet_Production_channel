...
HiInclusiveJetAnalyzer::beginJob() {
  ...
  h_B0_decay = fs1->make<TH1I>("h_B0_decay",h_B0_title.c_str(),10,-1,9);
  string h_B0bar_title=jetTagTitle+"B0bar_decay";
  h_B0bar_decay = fs1->make<TH1I>("h_B0bar_decay",h_B0bar_title.c_str(),10,-1,9);
  string h_Bp_title=jetTagTitle+"Bp_decay";
  h_Bp_decay = fs1->make<TH1I>("h_Bp_decay",h_Bp_title.c_str(),10,-1,9);
  string h_Bs_title=jetTagTitle+"Bs_decay";
  h_Bs_decay = fs1->make<TH1I>("h_Bs_decay",h_Bs_title.c_str(),10,-1,9);
  ...
  h_B0_chargeDaughters = fs1->make<TH1I>("h_B0_chargeDaughters",h_B0_charge_title.c_str(),B_CD_nbins,B_CD_binLo,B_CD_binHi);
  string h_Bpm_charge_title=jetTagTitle+"Bpm_chargeDaughters";                        
  h_Bpm_chargeDaughters = fs1->make<TH1I>("h_Bpm_chargeDaughters",h_Bpm_charge_title.c_str(),B_CD_nbins,B_CD_binLo,B_CD_binHi); 
  string h_Bs_charge_title=jetTagTitle+"Bs_chargeDaughters";                        
  h_Bs_chargeDaughters = fs1->make<TH1I>("h_Bs_chargeDaughters",h_Bs_charge_title.c_str(),B_CD_nbins,B_CD_binLo,B_CD_binHi); 
  string h_Bmesons_charge_title=jetTagTitle+"Bmesons_chargeDaughters";                        
  h_Bmesons_chargeDaughters = fs1->make<TH1I>("h_Bmesons_chargeDaughters",h_Bmesons_charge_title.c_str(),B_CD_nbins,B_CD_binLo,B_CD_binHi);                
